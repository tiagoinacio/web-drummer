...
// EXTERNAL MODULE: ./components/control-bar/style.css
var control_bar_style = __webpack_require__("mHPP");
var control_bar_style_default = /*#__PURE__*/__webpack_require__.n(control_bar_style);

// CONCATENATED MODULE: ./components/control-bar/index.js


function control_bar__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function control_bar__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function control_bar__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }





var control_bar__ref = Object(preact_min["h"])(
  'nav',
  null,
  Object(preact_min["h"])(
    'button',
...
var ControlBar = function (_Component) {
  control_bar__inherits(ControlBar, _Component);

  function ControlBar() {
    control_bar__classCallCheck(this, ControlBar);

    return control_bar__possibleConstructorReturn(this, _Component.apply(this, arguments));
  }

  ControlBar.prototype.render = function render() {
    return control_bar__ref;
  };
...
var _ref5 = Object(preact_min["h"])(ControlBar, null);
