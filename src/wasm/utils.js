...
function integrateWasmJS() {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'utils.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'utils.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'utils.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "utils.js.mem" : null;
